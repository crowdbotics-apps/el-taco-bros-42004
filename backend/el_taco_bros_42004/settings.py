"""
Django settings for el_taco_bros_42004 project.
...
ROOT_URLCONF = 'el_taco_bros_42004.urls'
...
WSGI_APPLICATION = 'el_taco_bros_42004.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "el_taco_bros_42004 API",
    "DESCRIPTION": "API documentation for el_taco_bros_42004 App",
    "VERSION": "v1",
}
